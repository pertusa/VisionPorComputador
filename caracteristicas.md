...
<!---
WM: Descriptors { (no BS)
    return points; (no BS)
    convexHull) (added 1 BS)
    added "puntos aleatorios"
    distancia de: (removed BS at the end)
    Added "usando caja de Feret"
    imageIndex = i+1;  (Added BS)
    << ".png"; (removed many BS at the end)
--->
